...
def create_bus(win, db, cursor, refresh_callback):
    window = ctk.CTkToplevel()
    window.transient(win)
    window.title("SwiftBus Admin - Create Bus")
    ...
    ctk.CTkLabel(
        master=form_frame, text="Create Bus", font=("Roboto", 16, "bold")
    ...
    bus_image_preview, bus_preview_set = ImagePreview(bus_image_select, 50, None)
