...
def create_location(win, db, cursor, refresh_callback):
    window = ctk.CTkToplevel()
    window.transient(win)
    window.title("SwiftBus Admin - Create Location")
    ...
    ctk.CTkLabel(
        master=form_frame, text="Create Location", font=("Roboto", 16, "bold")
